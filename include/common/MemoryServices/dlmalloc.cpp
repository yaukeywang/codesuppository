/*  HeroEngine, Copyright 2002-2006 Simutronics, Corp.  All rights reserved.
...
#pragma warning(disable: 4127 4267 4100 4702)
...
#define internal_malloc(m, b)\
   (m == gm)? (char *)dlmalloc(b) : (char *)mspace_malloc(m, b)
