...
public:
  ...
  virtual const float *   getVertices(void) const = 0;
  virtual const float *   getVertex(unsigned int index) const = 0;
...
// convenience helper functions.
  ...
  virtual void rotate(MeshSystemContainer *msc,float rotX,float rotY,float rotZ) = 0; // rotate mesh system using these euler angles expressed as degrees.
  ...
  virtual VertexIndex *            createVertexIndex(float granularity) = 0;  // create an indexed vertext system for floats
